...
public class sACNDataPacket {
    int packetLength = 638;
    InetAddress address;
    int port = 5568;
    ...
    public sACNDataPacket(String _name){
    ...
    public void setAllValues(byte[] _values){
        DMXValues = _values;
    }

    public void setOutputUniverse(int _universe){
        this.universe =
                new byte[]{(byte) ((_universe >> 8) & 0xFF), (byte) (_universe & 0xFF)};
    }
